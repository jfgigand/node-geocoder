...
var GeocoderFactory = {
  ...
  */
  _getGeocoder: function(geocoderName, adapter, extra) {
    ...
    if (geocoderName === 'frenchmappingagency') {
      var FrenchMappingAgencyGeocoder = require('./geocoder/frenchmappingagencygeocoder.js');

      return new FrenchMappingAgencyGeocoder(adapter, {apiKey: extra.apiKey});
    }
